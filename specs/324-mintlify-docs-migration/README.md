...
The LeanSpec documentation site (`codervisor/harnspec-docs`) currently runs on Docusaurus 3 deployed to Vercel. Mintlify is a modern AI-native documentation platform that offers a significantly better developer and reader experience—especially fitting for an AI-centric tool like LeanSpec.
