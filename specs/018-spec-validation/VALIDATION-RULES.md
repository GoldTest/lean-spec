...
This document details what gets validated by `harnspec validate` and the specific rules for each validation type.
...
Rules can be customized in `.harnspec/config.json`:
