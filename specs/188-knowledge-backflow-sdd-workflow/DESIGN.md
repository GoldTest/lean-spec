...
harnspec create feature-x
# ... implement ...
harnspec update feature-x --status complete  # Done!

# Enhanced workflow (with backflow):
harnspec create feature-x
harnspec update feature-x --status in-progress
# ... implement ...
# ... document learnings in spec ...
harnspec validate feature-x --check-reality  # NEW: Catches outdated content
harnspec update feature-x --status complete  # Checks spec freshness
```
...
- CLI: `harnspec agent review <spec>` command
