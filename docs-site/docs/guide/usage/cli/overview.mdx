...
**MCP Server Integration**: For seamless AI agent access, HarnSpec provides an [MCP (Model Context Protocol) server](/docs/reference/mcp-server) that exposes CLI functionality as structured tools.
