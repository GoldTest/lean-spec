...
**After setup:**
1. Run `harnspec board` to see the Kanban view
2. Edit your spec at `specs/001-my-first-feature/README.md`
3. Run `harnspec update 001 --status in-progress` when you start coding
4. Run `harnspec update 001 --status complete` when done
...
📖 [Full comparison with detailed analysis →](/docs/guide/why-harnspec)

## AI Integration

### Is HarnSpec only suitable for Claude models?

**No! HarnSpec works with any AI model or coding assistant.**

HarnSpec is model-agnostic by design:
...
### How do I integrate HarnSpec with Claude Code?
...
Or copy from: [AGENTS.md template](https://github.com/codervisor/harnspec/blob/main/AGENTS.md)
...
- **Bugs:** [GitHub Issues](https://github.com/codervisor/harnspec/issues)
- **Features:** [GitHub Discussions](https://github.com/codervisor/harnspec/discussions)

### Can I contribute?

Yes! See [CONTRIBUTING.md](https://github.com/codervisor/harnspec/blob/main/CONTRIBUTING.md).
...
- **Discussions:** [GitHub Discussions](https://github.com/codervisor/harnspec/discussions)
- **Issues:** [Bug tracker](https://github.com/codervisor/harnspec/issues)
...
**More questions?** Check the [full documentation](/docs/guide/) or ask in [GitHub Discussions](https://github.com/codervisor/harnspec/discussions).
