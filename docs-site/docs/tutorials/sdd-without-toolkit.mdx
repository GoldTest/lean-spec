...
sidebar_position: 5
description: Let AI set up a lightweight spec management system and practice HarnSpec methodology
---

# Practice SDD Without the Toolkit

Learn the **HarnSpec methodology** by having your AI agent build a custom spec management system for you. In minutes, you'll have a working SDD workflow—no toolkit installation required.

**Time**: 10 minutes  
**Outcome**: Working spec management system + AI-driven SDD workflow

:::tip Two Meanings of "HarnSpec"
1. **HarnSpec methodology** - The spec-driven development approach (this tutorial)
2. **HarnSpec toolkit** - The CLI/MCP/UI tools (`harnspec`, MCP server, etc.)
...
- Follow HarnSpec first principles
...
The HarnSpec methodology is built on 5 first principles (in priority order):
...
| Aspect | Custom Script (This Tutorial) | HarnSpec Toolkit |
|--------|------------------------------|------------------|
| **Setup** | AI creates in 2 min | `npm install -g harnspec` |
...
**HarnSpec methodology enables this workflow:**
...
- [Getting Started](/docs/guide/getting-started) - Install `harnspec`
...
**Questions?** Check [FAQ](/docs/faq) or [file an issue](https://github.com/codervisor/harnspec/issues).
