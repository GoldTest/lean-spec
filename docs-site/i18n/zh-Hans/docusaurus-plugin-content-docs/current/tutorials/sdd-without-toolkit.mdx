...
2. **HarnSpec 工具包** - CLI/MCP/UI 工具（`harnspec`、MCP 服务器等）
...
|------|---------------------|-----------------|
| **设置** | AI 在 2 分钟内创建 | `npm install -g harnspec` |
...
**准备尝试工具包？**
- [快速开始](/zh-Hans/docs/guide/getting-started) - 安装 `harnspec`
...
**有问题？** 查看 [常见问题](/zh-Hans/docs/faq) 或 [提交 Issue](https://github.com/codervisor/harnspec/issues)。
